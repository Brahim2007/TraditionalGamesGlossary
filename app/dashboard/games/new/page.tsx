...
const templateData: Array<{ field: string; value: string; hint?: string }> = [
  { field: "اسم اللعبة", value: "الركض بالحاجبين المرفوعين", hint: "عربي فقط - لا يقبل أحرف لاتينية (English) أو أرقام إنجليزية" },
  ...
  { field: "مجال التراث", value: "الألعاب الشعبية - الممارسات الاجتماعية والطقوس", hint: "القيم المعتمدة: الألعاب الشعبية - الممارسات الاجتماعية والطقوس | الألعاب الذهنية | الألعاب الحركية | ألعاب البنات | الألعاب البحرية | الألعاب الطريفة/الفكاهية" },
  { field: "نوع اللعبة", value: "طريفة / حركية", hint: "القيم المعتمدة: حركية | ذهنية | طريفة | بحرية | شعبية (يمكن دمج أكثر من نوع بـ /)" },
  { field: "تاجات التصنيف", value: "#تراث_خليجي، #ألعاب_طريفة، #ألعاب_حركية، #دولة_قطر" },
  { field: "الفئة العمرية", value: "9 - 12 سنة (الطفولة المتأخرة)", hint: "القيم المعتمدة: 3 - 6 سنوات (الطفولة المبكرة) | 6 - 9 سنوات (الطفولة المتوسطة) | 9 - 12 سنة (الطفولة المتأخرة) | 12 - 18 سنة (المراهقة) | الشباب والبالغين | جميع الأعمار" },
  { field: "وصف الفئة العمرية", value: "العمر الذي يمتلك فيه الطفل القدرة على 'فصل الحواس' والتحكم المستقل في عضلات الوجه مع تقبل الفكاهة.", hint: "هنا ضع التفاصيل والشرح الإضافي عن الفئة العمرية" },
  { field: "الممارسون", value: "مختلط (ذكور وإناث)", hint: "القيم المعتمدة: ذكور | إناث | مختلط (ذكور وإناث)" },
  { field: "وصف الممارسين", value: "لعبة مقبولة اجتماعياً للجنسين؛ تُلعب في 'الحوي' للفتيات وفي 'السكيك' للأولاد.", hint: "هنا ضع التفاصيل والشرح الإضافي عن الممارسين" },
  { field: "عدد اللاعبين", value: "6 - 10 لاعبين", hint: "أقصى طول 50 حرف - القيم المعتمدة: فردية | لاعبان اثنان | 2 - 4 لاعبين | 3 - 6 لاعبين | 4 - 8 لاعبين | 6 - 10 لاعبين | +10 لاعبين (جماعية كبيرة)" },
  { field: "وصف اللاعبين", value: "يبدأ من 3 أطفال، والعدد الكبير يزيد من صعوبة اللعبة بسبب 'عدوى الضحك'.", hint: "هنا ضع التفاصيل والشرح الإضافي عن عدد اللاعبين" },
  ...
  // حقول الأرشفة الإثنو-معرفية (اختياري)
  { field: "المعنى الإثنوغرافي للتسمية", value: "تعكس تسمية «الركض بالحاجبين المرفوعين» مفارقة جسدية–تعبيرية مقصودة، تقوم على الجمع بين أقصى الجهد البدني وأقصى مظاهر الدهشة الوجهية. التسمية تصف الفعل بدقة دون استعارة، ما يدل على وعي شعبي بكون جوهر اللعبة ليس الركض ذاته، بل القدرة على كبح ردود الفعل الطبيعية للوجه أثناء الحركة، وتحويل ذلك إلى مصدر للضحك والتحدي الاجتماعي." },
  { field: "الأصل اللغوي للتسمية", value: "الركض: فعل عربي فصيح يدل على العدو السريع. الحاجبان: مثنّى حاجب، من الجذر «حجب» بمعنى الستر، ويُستخدم هنا بوصفه عضوًا تعبيريًا. المرفوعين: صفة حالية تشير إلى الاستمرار والثبات. التسمية تركيب وصفي مباشر من العربية الدارجة الخليجية دون تحوير مجازي." },
  { field: "مستوى التعقيد المعرفي", value: "متوسط – يعتمد على التحكم العصبي-العضلي، تثبيت تعبير وجهي غير طبيعي أثناء الحركة السريعة، ومقاومة التشويش الاجتماعي (الضحك، الصيحات)، دون الحاجة إلى تخطيط استراتيجي طويل المدى." },
  { field: "الوظيفة المعرفية الشعبية", value: "تدريب التحكم الإرادي في العضلات الدقيقة للوجه، تنمية القدرة على فصل الإحساس الجسدي عن التعبير الانفعالي، تعزيز التركيز تحت الضغط الاجتماعي، وبناء وعي مبكر بالعلاقة بين الجسد، الانفعال، والمراقبة الجماعية." },
        ...
        >
          ...
          >
            ...
            <div className="overflow-y-auto p-0">
              ...
              {/* إرشادات توحيد البيانات */}
              <div className="border-b border-gray-200 bg-amber-50 p-4">
                <h4 className="font-bold text-amber-800 mb-2 text-sm">تنبيهات مهمة لتوحيد البيانات</h4>
                <ul className="text-xs text-amber-700 space-y-1.5 list-disc list-inside">
                  <li><strong>اسم اللعبة:</strong> عربي فقط - لا يقبل أحرف لاتينية أو أرقام إنجليزية</li>
                  <li><strong>عدد اللاعبين:</strong> استخدم الصيغة القصيرة (أقصى 50 حرف). التفاصيل الإضافية ضعها في «وصف اللاعبين»</li>
                  <li><strong>الفئة العمرية:</strong> استخدم الصيغة القصيرة. التفاصيل الإضافية ضعها في «وصف الفئة العمرية»</li>
                  <li><strong>الحقول الموحدة:</strong> الحقول المُعلّمة بـ <span className="inline-block bg-amber-100 text-amber-700 rounded px-1 text-[10px]">قيم معتمدة</span> يجب استخدام القيم المحددة فقط</li>
                  <li><strong>قواعد اللعب:</strong> كل قاعدة في سطر مستقل مع ترقيم (1. 2. 3.)</li>
                </ul>
              </div>
                  ...
                  {templateData.map((row, idx) => (
                    <tr key={idx} className="hover:bg-surface-muted">
                      ...
                      <td className="whitespace-pre-wrap px-6 py-4 align-top leading-relaxed text-gray-600">
                        {row.value}
                        {row.hint && (
                          <div className="mt-1.5 text-[11px] text-amber-700 bg-amber-50 border border-amber-200 rounded px-2 py-1 whitespace-normal">
                            {row.hint}
                          </div>
                        )}
                      </td>
...
نوع اللعبة: طريفة / حركية
تاجات التصنيف: #تراث_خليجي، #ألعاب_طريفة، #ألعاب_حركية
الفئة العمرية: 9 - 12 سنة (الطفولة المتأخرة)
...
3. الترفيه الجماعي وكسر الجليد
المعنى الإثنوغرافي للتسمية: تعكس تسمية «الركض بالحاجبين المرفوعين» مفارقة جسدية–تعبيرية مقصودة، تقوم على الجمع بين أقصى الجهد البدني وأقصى مظاهر الدهشة الوجهية. التسمية تصف الفعل بدقة دون استعارة، ما يدل على وعي شعبي بكون جوهر اللعبة ليس الركض ذاته، بل القدرة على كبح ردود الفعل الطبيعية للوجه أثناء الحركة، وتحويل ذلك إلى مصدر للضحك والتحدي الاجتماعي.
الأصل اللغوي للتسمية: الركض: فعل عربي فصيح يدل على العدو السريع. الحاجبان: مثنّى حاجب، من الجذر «حجب» بمعنى الستر، ويُستخدم هنا بوصفه عضوًا تعبيريًا. المرفوعين: صفة حالية تشير إلى الاستمرار والثبات. التسمية تركيب وصفي مباشر من العربية الدارجة الخليجية دون تحوير مجازي.
مستوى التعقيد المعرفي: متوسط – يعتمد على التحكم العصبي-العضلي، تثبيت تعبير وجهي غير طبيعي أثناء الحركة السريعة، ومقاومة التشويش الاجتماعي (الضحك، الصيحات)، دون الحاجة إلى تخطيط استراتيجي طويل المدى.
الوظيفة المعرفية الشعبية: تدريب التحكم الإرادي في العضلات الدقيقة للوجه، تنمية القدرة على فصل الإحساس الجسدي عن التعبير الانفعالي، تعزيز التركيز تحت الضغط الاجتماعي، وبناء وعي مبكر بالعلاقة بين الجسد، الانفعال، والمراقبة الجماعية.
المراجع:
...
2. وضع الاستعداد: رفع الحواجب لأقصى حد
3. الركض بسرعة قصوى دون إنزال الحاجبين
المعنى الإثنوغرافي للتسمية: تعكس تسمية «الركض بالحاجبين المرفوعين» مفارقة جسدية–تعبيرية مقصودة، تقوم على الجمع بين أقصى الجهد البدني وأقصى مظاهر الدهشة الوجهية.
الأصل اللغوي للتسمية: الركض: فعل عربي فصيح يدل على العدو السريع. الحاجبان: مثنّى حاجب، من الجذر «حجب» بمعنى الستر.
                </code>
              </div>
            </div>
