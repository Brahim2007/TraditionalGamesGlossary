...
const templateData = [
  ...
  { field: "المعنى الإثنوغرافي للتسمية", value: "تشير تسمية «الخربقة» في اللهجات المغاربية إلى الإرباك وإعادة خلط المسارات..." },
  { field: "الأصل اللغوي للتسمية", value: "الخربقة: جذر دارج مرتبط بالخلط والتشويش. السِّيجَة: من «سوّج» أي أحاط وحدّ..." },
  { field: "مستوى التعقيد المعرفي", value: "مرتفع – يعتمد على التخطيط متعدد المراحل، قراءة النوايا..." },
  { field: "الوظيفة المعرفية الشعبية", value: "تدريب التفكير الاستباقي، إدارة القيود، اتخاذ القرار تحت الضغط..." },
...
3. الترفيه الجماعي وكسر الجليد
المعنى الإثنوغرافي للتسمية: تشير تسمية «الخربقة» في اللهجات المغاربية إلى الإرباك وإعادة خلط المسارات...
الأصل اللغوي للتسمية: الخربقة: جذر دارج مرتبط بالخلط والتشويش. السِّيجَة: من «سوّج» أي أحاط وحدّ...
مستوى التعقيد المعرفي: مرتفع – يعتمد على التخطيط متعدد المراحل، قراءة النوايا...
الوظيفة المعرفية الشعبية: تدريب التفكير الاستباقي، إدارة القيود، اتخاذ القرار تحت الضغط...
المراجع:
